...
mkdir /tmp/XTandem && \
wget -O /tmp/XTandem/tandem.params https://raw.githubusercontent.com/Workflomics/containers/docker/cwl/tools/XTandem/tandem.params &&  \
...
/usr/local/tpp/bin/Tandem2XML /tmp/XTandem/tandemFile.tandem tandemPepXml.tandem.pep.xml