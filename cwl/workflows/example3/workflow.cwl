...
steps:
  Comet1:
    run: /data/escience/projects/bakeoff/Workflomics/containers/cwl/tools/Comet/Comet.cwl
    in:
      Comet_in_1: input1
      Comet_in_2: input2
    out: [Comet_out_1]
  PeptideProphet2:
    ...
    in:
      ...
      # Manual edit: PeptideProphet_in_2: input2 (FASTA)
...
# Manual edit: ProteinProphet_in_2: input2 (FASTA)
  ...
  protXml2IdList4:
    run: /data/escience/projects/bakeoff/Workflomics/containers/cwl/tools/protXml2IdList/protXml2IdList.cwl
    in:
